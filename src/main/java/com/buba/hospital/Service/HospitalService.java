...
public interface HospitalService {
    ...
    //添加数据库  咨询表\订单表
    Response addSecConsultation(SecDoctor doctor, int userid, String phone, String biaoti, String text, String fix, int paymentStatus, String orderNum, int state,double payMoney);
    //添加图片
    boolean addSecPicBySecConsultation(SecPic pic, int orderId);
    //根据咨询表id修改对应的支付状态 为已支付
    boolean updateConsultationState(int id, String orderNum);
